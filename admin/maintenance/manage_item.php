...
<div class="container-fluid">
	<form action="" id="item-form">
		...
		<div class="form-group">
			...
			<input type="text" name="name" id="name"  class="form-control rounded-0" value="<?php echo isset($name) ? $name : ''; ?>" pattern="[A-Za-z ]+" title="Please enter alphabetic characters and spaces only" required >
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="number" name="cost" id="cost" step="any" class="form-control rounded-0 text-end" value="<?php echo isset($cost) ? $cost : ''; ?>" pattern="[0-9]+" title="Please enter a valid number(numeric digits only)" required>
		</div>
		<div class="form-group">
