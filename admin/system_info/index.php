	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>"  pattern="[A-Za-z ]+" title="Please enter alphabetic characters and spaces only" required>
			</div>
			<div class="form-group">
				<label for="short_name" class="control-label">System Short Name</label>
				<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>" pattern="[A-Za-z ]+" title="Please enter alphabetic characters and spaces only" required>
			</div>
			<!-- <div class="form-group">
			...
			<div class="form-group d-flex justify-content-center">
				<img src="<?php echo validate_image($_settings->info('cover')) ?>" alt="" id="cimg2" class="img-fluid img-thumbnail" accept="image/jpeg, image/jpg, image/png">
			</div>
			</form>
		</div>
